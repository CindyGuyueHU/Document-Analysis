...
public class FileIndexBuilder {
	...
	private static final String INDEX_PATH = "src/search/lucene.index";
	private static final String DOCUMENT_PATH = "/Users/guyuehu/Desktop/Courses/comp6490/assignment1/gov-test-collection/documents";
	...
	public static void main(String[] args) throws Exception {
		...
		b.addFiles(FileFinder.GetAllFiles(DOCUMENT_PATH, null, true), true /*clear_old_index = false if adding*/);
