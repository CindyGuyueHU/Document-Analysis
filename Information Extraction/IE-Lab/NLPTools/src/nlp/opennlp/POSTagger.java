...
public class POSTagger {
	...
	public POSTagger() throws IOException {
		...
		_sdetector = new SharedSentenceDetector(
				"/Users/guyuehu/Desktop/Courses/comp6490/assignment5/IE-Lab/NLPTools/models/sentdetect/EnglishSD.bin.gz");

		// Load models for Tokenizer
		System.out.println("Loading models for Tokenizer...");
		_tokenizer = new Tokenizer(
				"/Users/guyuehu/Desktop/Courses/comp6490/assignment5/IE-Lab/NLPTools/models/tokenize/EnglishTok.bin.gz");

		// Load models for POS tagging
		System.out.println("Loading models for POS Tagging...");
		_tagger = new SharedPOSTagger(
				"/Users/guyuehu/Desktop/Courses/comp6490/assignment5/IE-Lab/NLPTools/models/postag/SpanishPOS.bin.gz", (Dictionary) null);
	}
